...
export const PROJECTS_DATA: Project[] = [
  { 
    ...
    screenshots: [
        { url: ' /assets/cosmetique/cosmetique1.png', labelKey: 'ss_landing', techBadge: 'React Components' },
        { url: ' /assets/cosmetique/cosmetique2.png', labelKey: 'ss_landing', techBadge: 'State Management' },
        { url: ' /assets/cosmetique/cosmetique3.png', labelKey: 'ss_landing', techBadge: 'Laravel API Logic' },
        { url: ' /assets/cosmetique/cosmetique4.png', labelKey: 'ss_landing', techBadge: 'Laravel API Logic' },
        { url: ' /assets/cosmetique/cosmetique5.png', labelKey: 'ss_landing', techBadge: 'Laravel API Logic' },
        { url: ' /assets/cosmetique/cosmetique6.png', labelKey: 'ss_landing', techBadge: 'Laravel API Logic' },
        { url: ' /assets/cosmetique/cosmetique7.png', labelKey: 'ss_filter', techBadge: 'Laravel API Logic' },
        { url: ' /assets/cosmetique/cosmetique8.png', labelKey: 'ss_products', techBadge: 'Laravel API Logic' },
        { url: ' /assets/cosmetique/cosmetique9.png', labelKey: 'ss_products', techBadge: 'Laravel API Logic' },
        { url: ' /assets/cosmetique/cosmetique10.png', labelKey: 'ss_products', techBadge: 'Laravel API Logic' },
        { url: ' /assets/cosmetique/cosmetique11.png', labelKey: 'ss_routines', techBadge: 'Laravel API Logic' },
        { url: ' /assets/cosmetique/cosmetique12.png', labelKey: 'ss_routines', techBadge: 'Laravel API Logic' },
        { url: ' /assets/cosmetique/cosmetique13.png', labelKey: 'ss_offres', techBadge: 'Laravel API Logic' },
        { url: ' /assets/cosmetique/cosmetique14.png', labelKey: 'ss_favorie', techBadge: 'Laravel API Logic' },
        { url: ' /assets/cosmetique/cosmetique15.png', labelKey: 'ss_paniers', techBadge: 'Laravel API Logic' },
        { url: ' /assets/cosmetique/cosmetique16.png', labelKey: 'ss_forms', techBadge: 'Laravel API Logic' },
        { url: ' /assets/cosmetique/cosmetique17.png', labelKey: 'ss_dashboard', techBadge: 'Laravel API Logic' },
        { url: ' /assets/cosmetique/cosmetique18.png', labelKey: 'ss_gestion_produits', techBadge: 'Laravel API Logic' },
        { url: ' /assets/cosmetique/cosmetique19.png', labelKey: 'ss_gestion_routines', techBadge: 'Laravel API Logic' },
        { url: ' /assets/cosmetique/cosmetique20.png', labelKey: 'ss_gestion_offres', techBadge: 'Laravel API Logic' },
    ],
    details: {
  ...
  { 
    ...
    color: '#3b82f6', // Blue
    screenshots: [
        { url: '/assets/pfe/pfe1.png', labelKey: 'ss_landing', techBadge: 'Blade Templates' },
        { url: '/assets/pfe/pfe2.png', labelKey: 'ss_landing', techBadge: 'Interactive Forms' },
        { url: '/assets/pfe/pfe3.png', labelKey: 'ss_landing', techBadge: 'Interactive Forms' },
        { url: '/assets/pfe/pfe4.png', labelKey: 'ss_forms', techBadge: 'Interactive Forms' },
        { url: '/assets/pfe/pfe5.png', labelKey: 'ss_landing', techBadge: 'Interactive Forms' },
        { url: '/assets/pfe/pfe6.png', labelKey: 'ss_forms', techBadge: 'Interactive Forms' },
        { url: '/assets/pfe/pfe7.png', labelKey: 'ss_forms', techBadge: 'Interactive Forms' },
        { url: '/assets/pfe/pfe8.png', labelKey: 'ss_landing', techBadge: 'Interactive Forms' },
        { url: '/assets/pfe/pfe9.png', labelKey: 'ss_landing', techBadge: 'Interactive Forms' },
        { url: '/assets/pfe/pfe10.png', labelKey: 'ss_landing', techBadge: 'Interactive Forms' },
        { url: '/assets/pfe/pfe11.png', labelKey: 'ss_filter', techBadge: 'Interactive Forms' },
        { url: '/assets/pfe/pfe12.png', labelKey: 'ss_dashboard', techBadge: 'Interactive Forms' },
        { url: '/assets/pfe/pfe13.png', labelKey: 'ss_dashboard', techBadge: 'Interactive Forms' },
    ],
    details: {
  ...
  color: '#6366f1', 
  screenshots: [
      { url: '/assets/pr/pr1.png', labelKey: 'ss_landing', techBadge: 'React Components' },
      { url: '/assets/pr/pr2.png', labelKey: 'ss_landing', techBadge: 'React Components' },
      { url: '/assets/pr/pr3.png', labelKey: 'ss_landing', techBadge: 'React Components' },
      { url: '/assets/pr/pr4.png', labelKey: 'ss_landing', techBadge: 'React Components' },
      { url: '/assets/pr/pr5.png', labelKey: 'ss_landing', techBadge: 'React Components' },
      { url: '/assets/pr/pr6.png', labelKey: 'ss_landing', techBadge: 'React Components' },
      { url: '/assets/pr/pr7.png', labelKey: 'ss_forms', techBadge: 'React Components' },
      { url: '/assets/pr/pr8.png', labelKey: 'ss_landing', techBadge: 'React Components' },
      { url: '/assets/pr/pr9.png', labelKey: 'ss_landing', techBadge: 'React Components' },
      { url: '/assets/pr/pr10.png', labelKey: 'ss_landing', techBadge: 'React Components' },
...
{ 
  ...
  color: '#6366f1', 
  screenshots: [
      { url: '/assets/innov/innov1.png', labelKey: 'ss_landing', techBadge: 'React Components' },
      { url: '/assets/innov/innov2.png', labelKey: 'ss_landing', techBadge: 'Responsive UI' },
      { url: '/assets/innov/innov3.png', labelKey: 'ss_landing', techBadge: 'Responsive UI' },
      { url: '/assets/innov/innov4.png', labelKey: 'ss_landing', techBadge: 'Responsive UI' },
      { url: '/assets/innov/innov5.png', labelKey: 'ss_landing', techBadge: 'Responsive UI' },
      { url: '/assets/innov/innov6.png', labelKey: 'ss_landing', techBadge: 'Responsive UI' },
      { url: '/assets/innov/innov7.png', labelKey: 'ss_landing', techBadge: 'Responsive UI' },
      { url: '/assets/innov/innov8.png', labelKey: 'ss_landing', techBadge: 'Responsive UI' },
      { url: '/assets/innov/innov9.png', labelKey: 'ss_landing', techBadge: 'Responsive UI' },
      { url: '/assets/innov/innov10.png', labelKey: 'ss_landing', techBadge: 'Responsive UI' },
      { url: '/assets/innov/innov11.png', labelKey: 'ss_landing', techBadge: 'Responsive UI' },
