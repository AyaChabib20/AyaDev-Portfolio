...
export const PROJECTS_DATA: Project[] = [
  { 
    ...
    screenshots: [
        { url: 'assets/cosmetique/1.png', labelKey: 'ss_landing', techBadge: 'React Components' },
        { url: 'assets/cosmetique/2.png', labelKey: 'ss_landing', techBadge: 'State Management' },
        { url: 'assets/cosmetique/3.png', labelKey: 'ss_landing', techBadge: 'Laravel API Logic' },
        { url: 'assets/cosmetique/4.png', labelKey: 'ss_landing', techBadge: 'Laravel API Logic' },
        { url: 'assets/cosmetique/5.png', labelKey: 'ss_landing', techBadge: 'Laravel API Logic' },
        { url: 'assets/cosmetique/6.png', labelKey: 'ss_landing', techBadge: 'Laravel API Logic' },
        { url: 'assets/cosmetique/7.png', labelKey: 'ss_filter', techBadge: 'Laravel API Logic' },
        { url: 'assets/cosmetique/8.png', labelKey: 'ss_products', techBadge: 'Laravel API Logic' },
        { url: 'assets/cosmetique/9.png', labelKey: 'ss_products', techBadge: 'Laravel API Logic' },
        { url: 'assets/cosmetique/10.png', labelKey: 'ss_products', techBadge: 'Laravel API Logic' },
        { url: 'assets/cosmetique/11.png', labelKey: 'ss_routines', techBadge: 'Laravel API Logic' },
        { url: 'assets/cosmetique/12.png', labelKey: 'ss_routines', techBadge: 'Laravel API Logic' },
        { url: 'assets/cosmetique/13.png', labelKey: 'ss_offres', techBadge: 'Laravel API Logic' },
        { url: 'assets/cosmetique/14.png', labelKey: 'ss_favorie', techBadge: 'Laravel API Logic' },
        { url: 'assets/cosmetique/15.png', labelKey: 'ss_paniers', techBadge: 'Laravel API Logic' },
        { url: 'assets/cosmetique/16.png', labelKey: 'ss_forms', techBadge: 'Laravel API Logic' },
        { url: 'assets/cosmetique/17.png', labelKey: 'ss_dashboard', techBadge: 'Laravel API Logic' },
        { url: 'assets/cosmetique/18.png', labelKey: 'ss_gestion_produits', techBadge: 'Laravel API Logic' },
        { url: 'assets/cosmetique/19.png', labelKey: 'ss_gestion_routines', techBadge: 'Laravel API Logic' },
        { url: 'assets/cosmetique/20.png', labelKey: 'ss_gestion_offres', techBadge: 'Laravel API Logic' },
    ],
    details: {
